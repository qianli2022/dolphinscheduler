...
CREATE TABLE `t_ds_process_definition` (
  ...
  `cluster_params` text DEFAULT NULL COMMENT 'cluster parameters',
  `create_time` datetime NOT NULL COMMENT 'create time',
...
CREATE TABLE `t_ds_cluster_process_definition_relation` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `cluster_code` bigint(20) NOT NULL COMMENT 'cluster code',
  `process_definition` varchar(255) NOT NULL COMMENT 'worker group id',
  `operator` int(11) DEFAULT NULL COMMENT 'operator user id',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
