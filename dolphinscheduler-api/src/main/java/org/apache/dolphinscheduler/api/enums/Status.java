...
public enum Status {
    ...
    CLUSTER_PROCESS_RELATION_IS_NULL(1200035, "cluster process is used", "工作流没有使用改集群"),
    ...
    QUERY_CAN_USE_K8S_NAMESPACE_ERROR(1300014, "login user query can used namespace list error", "查询可用命名空间错误"),
